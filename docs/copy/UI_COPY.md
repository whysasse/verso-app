...
| `onboarding.folder.privacyNote` | Caption below Continue button, once a folder is chosen | Verso never uploads your files. They live in your iCloud Drive. | Verso ne téléverse jamais tes fichiers. Ils restent dans ton iCloud Drive. | O Verso nunca envia seus arquivos para a nuvem. Eles ficam no seu iCloud Drive. | Added during step 4 view-wiring pass — missed in the original audit. |
